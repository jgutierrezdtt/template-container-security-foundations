...
Implementaras este control de CONTAINER de forma concreta sobre el archivo `Dockerfile` y registraras evidencia tecnica en `.tutorial/evidence/step-04.json`.
