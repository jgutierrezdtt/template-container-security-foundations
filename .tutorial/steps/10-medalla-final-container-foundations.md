...
- Campo o seccion objetivo: relacionado con "Medalla final container foundations".
...
- El cambio del paso 10 esta presente en `.github/workflows/container-security.yml`.
