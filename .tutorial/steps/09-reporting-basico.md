...
Implementaras este control de CONTAINER de forma concreta sobre el archivo `docs/container-security.md` y registraras evidencia tecnica en `.tutorial/evidence/step-09.json`.
