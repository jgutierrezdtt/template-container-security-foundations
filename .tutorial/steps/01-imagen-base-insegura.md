...
2. Editar la configuracion esperada en `Dockerfile`.
3. Guardar y subir el cambio en el flujo normal del repositorio (commit/push o PR).

## Que configurar exactamente

- Campo o seccion objetivo: relacionado con "Imagen base insegura".
- Ubicacion principal: `Dockerfile`.
- Resultado esperado: que la configuracion refleje el control del paso 1.

## Checklist de configuracion

- El cambio del paso 1 esta presente en `Dockerfile`.
